...
A basic knowledge of the components of an EML metadata file is essential to being able to take full advantage of the language. While more complete information can be found in the [official schema documentation](https://eml.ecoinformatics.org), here we provide a general overview of commonly used metadata elements most relevant to describing data tables.  
